  ...
  return (
    <div className="space-y-6">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
        {activeTab === 'generator' && <InvoiceGenerator businessProfile={businessProfile} invoices={invoices} setInvoices={setInvoices} clients={clients} inventory={inventory} setActiveTab={(t) => setActiveTab(t as any)} editingInvoiceId={editingInvoiceId} setEditingInvoiceId={setEditingInvoiceId} />}
