...
import * as AuthEmailOtp from '../backend/routes/auth/email-otp/route';
import * as AuthPhoneOtp from '../backend/routes/auth/phone-otp/route';
import * as AuthWhatsappOtp from '../backend/routes/auth/whatsapp-otp/route';
import * as ErpInventory from '../backend/routes/erp/inventory/route';
import * as ErpMaster from '../backend/routes/erp/master/route';
import * as ErpTransactions from '../backend/routes/erp/transactions/route';
import * as Keys from '../backend/routes/keys/route';
import * as LedgerSync from '../backend/routes/ledger/sync/route';
import * as RazorpayOrder from '../backend/routes/razorpay/order/route';
import * as RazorpayVerify from '../backend/routes/razorpay/verify/route';
import * as RazorpayWebhook from '../backend/routes/razorpay/webhook/route';
import * as SuggestNarration from '../backend/routes/suggest-narration/route';
